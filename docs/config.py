# -*- coding: utf-8 -*-
#
# Pflow documentation build configuration file, created by
# sphinx-quickstart on Wed Oct 12 13:56:58 2016.
#
...
latex_documents = [
  ('index', 'Pflow.tex', u'Pflow Documentation',
   u'wayhk', 'manual'),
]
...
man_pages = [
    ('index', 'Pflow', u'Pflow Documentation',
     [u'wayhk'], 1)
]
# If true, show URL addresses after external links.
#man_show_urls = False
...
texinfo_documents = [
  ('index', 'Pflow', u'Pflow Documentation', u'wayhk',
   'Pflow', 'One line description of project.', 'Miscellaneous'),
]
# Documents to append as an appendix to all manuals.
#texinfo_appendices = []
# If false, no module index is generated.
